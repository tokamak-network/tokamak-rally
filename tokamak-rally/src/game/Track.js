  ...
  zones: [
    {
      ...
      trackWidth: 110,
      scenery: ['v3_desert_cactus','v3_desert_scrub','v3_desert_rock_sm','v3_desert_rock_lg','v3_desert_cow','v3_desert_hut','v3_desert_fence','v3_desert_skull','v3_desert_scrub','v3_desert_rock_sm'],
      sceneryDensity: 5,
    ...
    },
    {
      ...
      trackWidth: 95,
      scenery: ['v3_desert_rock_sm','v3_desert_rock_lg','v3_canyon_pillar','v3_canyon_cliff','v3_canyon_bush','v3_desert_scrub'],
      sceneryDensity: 5,
    ...
    },
    {
      ...
      trackWidth: 75,
      scenery: ['v3_canyon_pillar','v3_canyon_debris','v3_canyon_cliff','v3_canyon_arch','v3_canyon_bush','v3_canyon_pillar','v3_canyon_debris'],
      sceneryDensity: 5,
      barrierTile: 'v3_barrier_canyon',
    },
    {
      ...
      trackWidth: 88,
      scenery: ['v3_canyon_debris','v3_canyon_bush','v3_riverbed_reeds','v3_riverbed_boulder','v3_riverbed_bush'],
      sceneryDensity: 5,
    ...
    },
    {
      ...
      trackWidth: 100,
      scenery: ['v3_riverbed_tree','v3_riverbed_bush','v3_riverbed_reeds','v3_riverbed_boulder','v3_riverbed_bush','v3_riverbed_reeds','v3_riverbed_tree'],
      sceneryDensity: 6,
      barrierTile: 'v3_barrier_riverbed',
    },
    {
      ...
      trackWidth: 90,
      scenery: ['v3_riverbed_boulder','v3_riverbed_bush','v3_mountain_rock','v3_mountain_pine','v3_mountain_pole'],
      sceneryDensity: 5,
    ...
    },
    {
      ...
      trackWidth: 80,
      scenery: ['v3_mountain_pine','v3_mountain_rock','v3_mountain_cabin','v3_mountain_snowman','v3_mountain_pine','v3_mountain_rock','v3_mountain_pole','v3_mountain_pine'],
      sceneryDensity: 6,
      barrierTile: 'v3_barrier_mountain',
    },
    {
      ...
      trackWidth: 100,
      scenery: ['v3_mountain_rock','v3_sprint_lamp','v3_sprint_building_low','v3_mountain_pole'],
      sceneryDensity: 5,
    ...
    },
    {
      ...
      trackWidth: 120,
      scenery: ['v3_sprint_building_tall','v3_sprint_building_low','v3_sprint_lamp','v3_sprint_billboard','v3_sprint_tire_wall','v3_sprint_ad_board','v3_sprint_grandstand','v3_sprint_building_tall'],
      sceneryDensity: 7,
      barrierTile: 'v3_barrier_sprint',
    },
  ],
