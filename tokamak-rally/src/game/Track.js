...
export const TRACK_CONFIG = {
  ...
  zones: [
    ...
    },
    {
      ...
      trackWidth: 95,
      scenery: ['v2_desert_rock','v2_canyon_pillar','v2_canyon_cliff'],
      sceneryDensity: 3,
    ...
    },
    {
      ...
      trackWidth: 75,
      scenery: ['v2_canyon_pillar','v2_canyon_debris','v2_canyon_cliff'],
      sceneryDensity: 1,
      barrierTile: 'v2_barrier_canyon',
    },
    {
      ...
      trackWidth: 88,
      scenery: ['v2_canyon_debris','v2_riverbed_reeds','v2_riverbed_boulder'],
      sceneryDensity: 2,
    ...
    },
    {
      ...
      trackWidth: 90,
      scenery: ['v2_riverbed_boulder','v2_mountain_rock','v2_mountain_pine'],
      sceneryDensity: 3,
    ...
    },
    {
      ...
      trackWidth: 100,
      scenery: ['v2_mountain_rock','v2_sprint_lamp'],
      sceneryDensity: 2,
