...
export class RaceScene extends Phaser.Scene {
  ...
  placeScenery() {
    ...
    const scaleMap = {
      ...
      // v4 assets — 2x resolution sprites, halved scale for game display
      'v4_desert_cactus_tall': 0.5, 'v4_desert_cactus_barrel': 0.4,
      'v4_desert_rock_sm': 0.35, 'v4_desert_rock_lg': 0.45,
      'v4_desert_bush': 0.35, 'v4_desert_tumbleweed': 0.3,
      'v4_desert_hut': 0.45, 'v4_desert_fence': 0.4,
      'v4_desert_cow': 0.4, 'v4_desert_dry_grass': 0.25,
      'v4_canyon_pillar': 0.5, 'v4_canyon_debris_sm': 0.35,
      'v4_canyon_wall': 0.5, 'v4_canyon_arch': 0.5,
      'v4_canyon_dead_bush': 0.35, 'v4_canyon_rock': 0.4,
      'v4_canyon_debris_lg': 0.3, 'v4_canyon_barrier': 0.4,
      'v4_riverbed_tree': 0.5, 'v4_riverbed_bush': 0.4,
      'v4_riverbed_reeds': 0.35, 'v4_riverbed_rock': 0.35,
      'v4_riverbed_puddle': 0.4, 'v4_riverbed_log': 0.4,
      'v4_riverbed_bird': 0.25,
      'v4_mountain_pine': 0.5, 'v4_mountain_rock_snow': 0.4,
      'v4_mountain_cabin': 0.5, 'v4_mountain_snowman': 0.35,
      'v4_mountain_bush': 0.35, 'v4_mountain_sign': 0.3,
      'v4_mountain_sign_arrow': 0.3, 'v4_mountain_rock_flat': 0.35,
      'v4_mountain_snow_pile': 0.3, 'v4_mountain_stone_wall': 0.4,
      'v4_sprint_office': 0.5, 'v4_sprint_hotel': 0.5,
      'v4_sprint_apartment': 0.5, 'v4_sprint_skyscraper': 0.6,
      'v4_sprint_restaurant': 0.4, 'v4_sprint_cones': 0.25,
      'v4_sprint_tires': 0.3, 'v4_sprint_generator': 0.35,
      'v4_sprint_light': 0.4, 'v4_sprint_grandstand': 0.5,
      'v4_sprint_jersey': 0.4, 'v4_sprint_catch_fence': 0.45,
      'v4_sprint_banner': 0.5, 'v4_sprint_tire_stack': 0.35,
    };
